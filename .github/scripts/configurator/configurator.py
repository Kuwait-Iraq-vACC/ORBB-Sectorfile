...
def fix_orbb_paths(lines):
    ...
    for line in lines:
        ...
        # Handles both the case where the value starts directly with "ORBB"
        # and the case where it starts with a leading backslash before "ORBB"
        # (e.g. \ORBB-Developer-Package_20260705001019-260601-0003.sct),
        # normalising both to "\..\ORBB..." without double-fixing lines that
        # already have "\.." or ".." in front.
        line = re.sub(
